...
//        });
      ...
      initFilters() {
        this.$store.commit("areaActive", 0);
        this.$store.commit("yearActive", 0);
        this.$store.commit("typeActive", 0);
        this.$store.commit("terminalActive", 0);

        this.$store.commit("region", "");
        this.$store.commit("year", "");
        this.$store.commit("genre", "");
        this.$store.commit("terminal", "");
      }     //将影片筛选的条件初始化
    },
    filters: {
      isActive(v1, v2, v3){
