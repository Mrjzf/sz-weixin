<template>
  <div id="recommend1">
    ...
    <div class="everyBlock" v-for="(item, index) in data"
         @click="goShow(item.shengChannelId, item.contentId, item.channelName, item.currProgramName, item.params, item.poster)">
